...
async def chatbot(client, message):
    ...
    umm = await message.reply_sticker("CAADBAADaQsAAkJZ_QTmSPVmiO_lkQI")
    await asyncio.sleep(2)
    await message.reply_photo(
        photo=f"https://telegra.ph/file/c61e7d5d1f49103e6873a.jpg",
        caption=f"""━━━━━━━━━━━━━━━━━━━━━━━━
💥 A ᴘᴏᴡᴇʀғᴜʟ ᴀɪ ʙᴏᴛ
ᴏғ ♻️ ᴅʀ ᴀsᴀᴅ ᴀʟɪ 🔥
━━━━━━━━━━━━━━━━━

IF HAVE ANY QUESTION THEN CONTACT » TO » MY » [OWNER] @pandit_Andy""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 Andy ᴄʜᴀᴛ 💮", url=f"https://t.me/pandit_Andy")]]
        ),
    ) 
...
async def start(client, message):
    await message.reply_text(f"**Andy ᴀɪ ᴜsᴇʀʙᴏᴛ ғᴏʀ ᴄʜᴀᴛᴛɪɴɢ ɪs ᴡᴏʀᴋɪɴɢ**")
